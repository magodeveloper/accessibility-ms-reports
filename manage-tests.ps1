...
<#
.SYNOPSIS
    Script completo para gestión de tests del microservicio Reports con dashboard dinámico
.DESCRIPTION
...
.EXAMPLE
    .\manage-tests.ps1 test -Filter "Reports.Application"
    Ejecuta solo tests que contengan "Reports.Application"
#>
...
$ProjectName = "Reports Microservice"
$SolutionFile = "Reports.sln"
$TestProject = "src\Reports.Tests\Reports.Tests.csproj"
        ...
        <div class="details-grid">
            <div class="detail-card">
                ...
                <div class="assembly-row assembly-excluded">
                    <div class="assembly-name">✅ Reports.Infrastructure</div>
                    <div class="assembly-coverage">
...
function Show-Help {
    Write-Banner "📚 AYUDA - GESTOR DE TESTS REPORTS MICROSERVICE"
...
PARÁMETROS:
    -Filter <filtro>        Filtra tests específicos (ej: "Reports.Application")
...
EJEMPLOS:
    ...
    .\manage-tests.ps1 test -Filter "Reports.Application" 
        Ejecuta solo tests de Reports.Application
